...
CREATE TABLE fichaanamnese(
  ...
  telefoneMedicoAssistente VARCHAR(15),
...
CREATE TABLE tratamento(
    ...
    dataInicioDia VARCHAR(3),
    dataInicioMes VARCHAR(3),
    dataInicioAno VARCHAR(5),	
    idFichaAnamnese INTEGER,
    idOdontograma INTEGER,
    idCliente INTEGER,    
    FOREIGN KEY (idFichaAnamnese) REFERENCES fichaanamnese(id),
