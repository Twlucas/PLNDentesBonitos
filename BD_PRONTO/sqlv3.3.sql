...
CREATE TABLE tratamento(
    ...
    indicaçao VARCHAR(500),
    atendimentoinicial VARCHAR(500),
...
CREATE TABLE procedimentododente(
    ...
    regiao INTEGER,
    face INTEGER,
    procedimentoIndicado VARCHAR(500),
...
CREATE TABLE recibo(
	nrRecibo INTEGER NOT NULL AUTO_INCREMENT,
    valor FLOAT,
